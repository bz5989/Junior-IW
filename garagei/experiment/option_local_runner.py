...
class OptionLocalRunner(LocalRunner):
    ...
    def save(self, epoch, new_save=False, pt_save=False, pkl_update=False):
        ...
        if new_save and epoch != 0:
            ...
            if self._algo.traj_encoder is not None and self._algo.algo != 'sac' and self._algo.algo != 'ppo':
            ...
            if 'phi_encoder' in self._algo.param_modules:
                file_name = os.path.join(self._snapshotter._snapshot_dir, f'phi_encoder{epoch}.pt')
                torch.save({
